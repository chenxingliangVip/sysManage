<template>
	<div id="fullscreenDom22" @click='clickScreen'>
		<svg t="1508738709248" class="screenfull-svg" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2069" xmlns:xlink="http://www.w3.org/1999/xlink" width="32" height="32">
...
<script>
	...
	export default {
		...
		mounted() {
			let self = this;
			self.$eventBus.$on("openFun", function() {
				self.clickScreen();
			});
		}
	}
