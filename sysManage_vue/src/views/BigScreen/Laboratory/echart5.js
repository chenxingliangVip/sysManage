...
var dataRan = [];
var colorRan = ['#00cfff', '#fd6f97', ]
for (var i = 0; i < trafficWayRan.length; i++) {
    dataRan.push({
        value: trafficWayRan[i].value,
        name: trafficWayRan[i].name,
        itemStyle: {
            normal: {
                borderWidth: 5,
                shadowBlur: 20,
                borderColor: colorRan[i],
                shadowColor: colorRan[i]
            }
        }
    }, {
        value: 2,
