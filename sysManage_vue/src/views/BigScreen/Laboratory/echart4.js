...
var dataYan = [];
var colorYan = ['#00ffff', '#ff4343', ]
for (var i = 0; i < trafficWayYan.length; i++) {
    dataYan.push({
        value: trafficWayYan[i].value,
        name: trafficWayYan[i].name,
        itemStyle: {
            normal: {
                borderWidth: 5,
                shadowBlur: 20,
                borderColor: colorYan[i],
                shadowColor: colorYan[i]
            }
        }
    }, {
        value: 2,
